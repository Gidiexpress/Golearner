...
export const FUNCTIONS: FunctionDefinition[] = [
  ...
  },
  {
    ...
    explanations: [
      "Declares the ThirdTimeIsACharm function. It picks out every 3rd letter, like a lucky pattern!",
      "Checks if the text is too short (less than 3 letters). If so, return an empty string.",
      "Creates an empty string 'res' to store our lucky collection of letters.",
      "Loops through the text, starting at index 2 (the 3rd letter) and jumping forward by 3 ('i += 3') each time.",
      "Adds the character we found to our 'res' string.",
      "End of the loop.",
      "Return the collection of letters we found.",
      "The final '}' ends the function."
    ],
  ...
  },
  {
    ...
    explanations: [
      "Declares the ZipString function. It shrinks text by counting repeated letters.",
      "If the text is empty, return an empty string immediately.",
      "Creates an empty string 'res' to store our zipped-up result.",
      "Creates a variable 'count' and sets it to 1. We start by seeing at least one of each letter.",
      "Loops through the text starting from the second letter (index 1).",
      "Checks if the current letter is the same as the one before it.",
      "If they match, add 1 to our 'count'.",
      "If they DON'T match, it's a new letter sequence! Add the count and the previous letter to 'res'.",
      "Turn the count number into text using 'strconv.Itoa(count)' and add it to the result.",
      "Reset 'count' back to 1 for the new letter we just found.",
      "End of the decision block.",
      "End of the loop.",
      "After the loop, don't forget to add the very last letter and its count!",
      "Return the final zipped string.",
      "The final '}' ends the function."
    ],
  ...
  },
  {
    ...
    explanations: [
      "Declares the WeAreUnique function. It counts letters that are in one word but not the other.",
      "If both words are empty, return -1 to signal a mistake.",
      "Creates a variable 'count' and sets it to 0. This will store the final answer.",
      "Creates two 'maps' (special memory notebooks) to remember all letters in S1 and S2.",
      "Uses a 'make' function to build these notebooks. 'rune' is just a fancy name for a letter.",
      "Loops through S1 and marks every letter we see in the first notebook.",
      "Loops through S2 and marks every letter we see in the second notebook.",
      "Loops through the first notebook. If a letter is NOT in the second notebook ('!'), add 1 to 'count'.",
      "Loops through the second notebook. If a letter is NOT in the first notebook, add 1 to 'count' too.",
      "Return the total number of unique letters we found.",
      "The final '}' ends the function."
    ],
    defaultArgs: ["abc", "bcd"],
  ...
  },
  {
    ...
    explanations: [
      "Declares the AddPrimeSum function which adds up prime numbers.",
      "If the number is 1 or less, return 0 because there are no primes there.",
      "Creates a variable 'sum' and starts it at 0.",
      "Loops through every number 'i' from 2 up to our target 'n'.",
      "Checks if the number 'i' is prime. If it's a prime gem, add it to our 'sum'.",
      "End of the loop.",
      "Return the final total of all the primes we added up.",
      "The final '}' ends the function."
    ],
    defaultArgs: [10],
  ...
  },
  {
    ...
    explanations: [
      "Declares the CanJump function. It's like a parkour puzzle!",
      "If there are no steps, return false because we can't even start.",
      "If there is only 1 step, we are already at the finish line! Return true.",
      "Creates a variable 'furthest' to track the best jump we can make so far.",
      "Loops through all the steps. 'i' is where we are, and 'jump' is our power.",
      "If where we are ('i') is past our 'furthest' possible reach, we are stuck! Return false.",
      "Updates our 'furthest' reach if jumped from the current spot gives us a better landing.",
      "Checks if we can already reach the very last step. If yes, return true!",
      "End of the loop.",
      "If we finish checking and never reached the end, return false.",
      "The final '}' ends the function."
    ],
  ...
  },
  {
    ...
    explanations: [
      "Declares the Chunk function. It chops a long list into smaller bite-sized pieces!",
      "Checks if the chunk size is 0 or less. If so, just print a blank line and stop (return).",
      "Loops through the list, jumping forward by 'size' ('i += size') each step to find the next piece.",
      "Calculates where the current piece should end.",
      "If the piece is too long for the rest of the list, we cap it at the very end.",
      "Displays the piece using special 'slice' syntax 'slice[i:end]'.",
      "End of the loop.",
      "The final '}' ends the function."
    ],
  ...
  },
  {
      ...
      explanations: [
        "Declares the ConcatAlternate function. It mixes two lists like a game of catch!",
        "Creates a new empty list 'res' to store our mixed-up numbers.",
        "Loops as long as there are numbers left in EITHER side (using '||' which means OR).",
        "If there's a number at the current spot in the first list, add it to 'res'.",
        "If there's a number at the current spot in the second list, add it to 'res' too.",
        "End of the loop step.",
  ...
  },
  {
    ...
    explanations: [
      "Declares the ConcatSlice function. It glues two slices together into one big list!",
      "Uses the 'append' tool to combine them. The '...' means 'grab every single item from the second list'.",
      "The final '}' ends the function."
    ],
    defaultArgs: [[1, 2], [3, 4]],
    quizHints: ["slice2..."],
  ...
  },
  {
      ...
      explanations: [
        "Declares the Fprime function. It breaks numbers down into their prime building blocks!",
        "If the number is 1 or less, stop immediately.",
        "Loops from 2 up to 'n' to find numbers that divide it perfectly.",
        "Checks if 'n' is divisible by 'i' using '%' (the remainder tool).",
        "If the remainder is 0, we found a block! Display the number 'i'.",
        "If we have more blocks to find, print a '*' and call the function again with the rest ('n/i').",
        "Stops finding blocks for this round once we find one.",
        "End of the loop and decisions.",
        "The final '}' ends the function."
      ],
      defaultArgs: [42],
  ...
  },
  {
    ...
    explanations: [
      "Declares the HiddenP function. It's like finding a secret word inside another word!",
      "If the secret word is empty, we technically found 'nothing' everywhere! Return 1.",
      "Creates a variable 'j' starting at 0 to track which letter of the secret word we're looking for.",
      "Loops through the big word. As long as we have letters left to find in BOTH words (using '&&').",
      "If the current letter in the big word matches our target secret letter, move to the next secret letter ('j++').",
      "End of the loop.",
      "If 'j' is equal to the length of the secret word, we found every letter! Return 1 (True).",
  ...
  },
  {
    ...
    explanations: [
      "Declares the Inter function. It finds the common letters between two friends!",
      "Loops through each character 'r1' in the first word.",
      "Checks if 's2' (the second word) contains the current letter 'r1'.",
      "If found, convert the letter back to text and display it.",
      "Removes ALL of that character from 's2' so we don't count it twice.",
      "End of the check and loop.",
      "The final '}' ends the function."
    ],
  ...
  },
  {
    ...
    explanations: [
      "Declares the ReverseStrCap function. It flips text and turns small letters into BIG ones!",
      "Creates an empty string 'res' to store our flipped result.",
      "Loops backward from the last letter to the first one using 'i--'.",
      "Grabs the character at position 'i' and saves it as 'char'.",
      "If the character is a small letter ('a' to 'z'), subtract 32 from its ID to make it BIG.",
      "Adds the character back to our 'res' string.",
      "End of the loop.",
      "Return the flipped and capitalized text.",
      "The final '}' ends the function."
    ],
    defaultArgs: ["Hello"],
  ...
  },
  {
      ...
      explanations: [
        "Declares the SaveAndMiss function. It keeps some items and skips others like a game of leapfrog!",
        "If the skip number 'n' is 0 or less, just return the original word.",
        "Creates an empty string 'res' to store the items we decide to keep.",
        "Loops through the text, jumping forward by '2 * n' each time.",
        "Calculates where the part we keep should end ('i + n').",
        "If the end goes past the length of the word, we stop at the very end.",
        "Adds the part of the word we kept ('s[i:end]') to our result.",
        "End of the loop.",
        "Return the final combined result of all the parts we kept.",
        "The final '}' ends the function."
      ],
  ...
  },
  {
    ...
    explanations: [
      "Declares the Union function. It merges two words into one big list of unique letters!",
      "Creates an empty string 'res' to store our final collection.",
      "Glues the two words together into one giant word using '+'.",
      "Loops through every letter 'r' in the giant combined word.",
      "Checks if the letter is NOT in our result yet using '!' (the NOT tool).",
      "If it's a new letter we haven't seen, add it to our 'res' result.",
      "End of the check and loop.",
      "Return the final list of all unique letters we found.",
      "The final '}' ends the function."
    ],
    defaultArgs: ["hello", "world"],
  ...
  },
  {
    ...
    explanations: [
      "Declares the WdMatch function. It checks if you can build word A by deleting characters from word B.",
      "Creates a variable 'i' at 0 to track which letter of the target word we're looking for.",
      "Loops through the second word. We stop when we reach the end of either word.",
      "If the current letters match, move to the next letter of the target word ('i++').",
      "End of the loop.",
      "If 'i' is equal to the length of the target word, we found all its letters in order! Return true.",
      "The final '}' ends the function."
    ],
  ...
  },
  {
      ...
      explanations: [
        "Declares the FifthAndSkip function. It's like playing musical chairs with letters!",
        "If the word is empty, just return a new line character.",
        "Creates an empty string 'res' and a 'count' starting at 0.",
        "Loops through every character 'r' in the text.",
        "If the character is a space, skip it and move to the next one (continue).",
        "If we have counted 5 letters, add a space to the result, reset 'count' to 0, and skip the current letter.",
        "Add the current letter 'r' to our 'res' result.",
        "Add 1 to our 'count' to keep track of how many we've added.",
        "End of the loops and decisions.",
        "Return the result with a new line at the end.",
        "The final '}' ends the function."
      ],
      defaultArgs: ["123456789"],
  ...
  },
  {
    ...
    explanations: [
      "Declares the NotDecimal function. It checks if something is NOT a regular number.",
      "If the word is empty, we say it's 'not a decimal' because there's nothing there!",
      "Loops through each character 'r' in the word. 'i' is the character's position.",
      "If it's the very first letter ('i == 0') and it's a minus sign '-', we skip it and keep checking.",
      "Checks if the character is NOT a digit (less than '0' or greater than '9').",
      "End of the loop. If we found a non-digit, return true (it's not a decimal!).",
      "If we checked everything and it looked like a number, return false.",
      "The final '}' ends the function."
    ],
    defaultArgs: ["123a"],
  ...
  },
  {
      ...
      explanations: [
        "Declares the RevConcatAlternate function. It flips lists and then mixes them up!",
        "Flips list A using a clever 'for' loop and a parallel swap: 's1[i], s1[j] = s1[j], s1[i]'.",
        "Flips list B using the same flip-around trick.",
        "Creates a new empty list 'res' to store our final mixed numbers.",
        "Loops as long as there are items left in EITHER flipped list (using '||').",
        "If we still have items in list A, add the current one to 'res'.",
        "If we still have items in list B, add the current one to 'res' too.",
        "End of the mixing loop.",
        "Return the final combined and flipped list.",
        "The final '}' ends the function."
      ],
      defaultArgs: [[1, 2], [3, 4, 5]],
  ...
  },
  {
    ...
    explanations: [
      "Declares the Slice function. It cuts out a specific piece of a list, like a slice of cake!",
      "Checks for mistakes: like trying to start after you end, or starting with a negative number.",
      "If the 'end' point is further than the list goes, we stop at the very end.",
      "Creates a new empty list 'res' for our slice.",
      "Loops from the 'start' point to just before the 'end' point.",
      "Adds each item in that range to our 'res' slice.",
      "End of the loop.",
      "Return the final sliced-out piece of the list.",
      "The final '}' ends the function."
    ],
  ...
  },
  {
    ...
    explanations: [
      "Declares the FindPairs function. It finds pairs of numbers that add up to a target sum!",
      "Creates a new empty list 'res' (a list of lists!) to store the pairs we find.",
      "The outer loop picks the first number from the list.",
      "The inner loop picks a second number that comes after the first one.",
      "Checks if the sum of both numbers is exactly equal to our 'target'.",
      "If they are a perfect match, add both numbers together as a pair into our 'res' list.",
      "End of both loops and the check.",
      "Return the final list of all the matching pairs we found.",
      "The final '}' ends the function."
    ],
  ...
  },
  {
      ...
      explanations: [
        "Declares the RevWstr function. It flips the order of words in a sentence!",
        "Splits the sentence into a list of words using 'strings.Fields'.",
        "Creates an empty string 'res' to build our flipped sentence.",
        "Loops backward from the last word to the first one using 'i--'.",
        "Adds each word to our 'res' result.",
        "If there are more words to add, put a space between them.",
        "End of the loop.",
        "Return the final sentence where the words are in reverse order.",
        "The final '}' ends the function."
      ],
  ...
  },
  {
      ...
      explanations: [
      "Declares the RoString function. It moves the first word to the very end!",
      "Breaks the sentence into a list of words.",
      "If there are no words, return an empty string.",
      "Joins all the words starting from the second one ('words[1:]') back into a sentence.",
      "If there was more than one word, add a space to separate the middle parts from the new end.",
      "Adds the very first word ('words[0]') to the end of the sentence.",
      "Return the final rotated sentence.",
      "The final '}' ends the function."
    ],
  ...
  },
  {
      ...
      explanations: [
      "Declares the WordFlip function. It mirrors the order of every word in a sentence!",
      "Splits the sentence into a list of words.",
      "If there's nothing to flip, return an empty string.",
      "Uses two pointers 'i' and 'j' to start at both ends and work toward the middle.",
      "The Go swap! 'words[i], words[j] = words[j], words[i]' lets the words switch places instantly.",
      "End of the swap loop.",
      "Joins the words back together with spaces and returns the flipped sentence.",
      "The final '}' ends the function."
    ],
  ...
  },
  {
    ...
    explanations: [
      "Declares the ItoaBase function. It translates numbers between different robot languages (like Binary or Hex)!",
      "Checks if the 'base' language is supported (between 2 and 16).",
      "Creates a list of possible digits '0123456789ABCDEF'.",
      "Creates an empty result 'res' and checks if the number is negative.",
      "If it's negative, we turn it positive for a moment to extract the digits.",
      "Loops through the number as long as it's greater than 0.",
      "Finds the remainder using '% base' and picks the right character to put at the FRONT of our result.",
      "Divide the number by the base to move to the next digit.",
      "End of the digit loop.",
      "If the number started as negative, add the '-' sign back to the front.",
  ...
  },
  {
    ...
    explanations: [
      "Declares the PigLatin function. It translates normal words into funny Oigpay Atinlay!",
      "Creates a list of vowel sounds 'aeiou'.",
      "Creates a 'firstVowel' marker starting at -1 (which means 'not found yet').",
      "Loops through the word to find the very first vowel.",
      "If we find a vowel, save its position and stop looking (break).",
      "End of the search loop.",
      "If we finished the loop and found no vowels, return an error message.",
      "Chopping time! Grab everything from the first vowel to the end, add the start of the word, then add 'ay' at the end.",
      "The final '}' ends the function."
    ],
    defaultArgs: ["pig"],
  ...
  },
  {
    ...
    explanations: [
      "Declares the RomanNumbers function. It translates numbers into ancient Roman symbols!",
      "Checks if the number is in the allowed range (1 to 3999).",
      "Creates two lists: one for values (like 1000 or 500) and one for their Roman symbols (like M or D).",
      "Creates an empty result 'res' to build our Roman numerals.",
      "Loops through each value in our list one by one.",
      "A second loop: as long as our number 'n' is bigger than the value, we can use that symbol!",
      "Adds the symbol to our 'res' string and subtracts the value from 'n'.",
      "End of our nested loops.",
      "Return the final string of ancient Roman symbols.",
      "The final '}' ends the function."
    ],
    defaultArgs: [2024],
  ...
  },
  {
    ...
    explanations: [
      "Declares the Brackets function. It checks if every bracket has a partner and is closed correctly!",
      "Creates a 'stack' (like a stack of pancakes) to remember which brackets are still open.",
      "Creates a 'map' notebook to pair closing brackets like ')' with their partners like '('.",
      "Loops through every character in the text.",
      "If the character is an opening bracket, add it to our stack to remember it.",
      "If it's a closing bracket, we check if it matches the last one we opened.",
      "If the stack is empty or the last bracket doesn't match, the balance is wrong! Return false.",
      "Remove the last bracket from our memory stack once it's matched.",
      "End of our checks and the loop.",
      "Return true if our memory stack is empty (meaning all brackets were matched!).",
      "The final '}' ends the function."
    ],
    defaultArgs: ["([{}])"],
  ...
  },
  {
    ...
    explanations: [
      "Declares the Brainfuck function. It's a tiny brain-teasing language for robots!",
      "Creates a huge memory tape of 30,000 cells for our robot to use.",
      "Creates a pointer 'ptr' to track where the robot is looking on the tape.",
      "Loops through every character of the secret code.",
      "Uses a 'switch' to decide what to do based on each symbol.",
      "Commands: '>' moves the robot right, '<' moves it left, '+' and '-' change the data in the cell.",
      "The '.' command tells the robot to display the character stored in the current cell.",
      "End of the switch, the loop, and the function!"
    ],
    defaultArgs: ["++++[>++++<-]>."],
  ...
  },
  {
    ...
    explanations: [
      "Declares the Options function. it checks if secret 'flags' are valid correctly.",
      "Creates a variable 'res' with 0 to store our final flag markers.",
      "Loops through each secret code (argument) in the list.",
      "If code is too short or doesn't start with a dash '-', it's a mistake! Return -1.",
      "Loops through every letter in the secret code.",
      "Uses fancy math (bitwise shifting) to flip a switch in 'res' for every letter found.",
      "End of our nested loops and checks.",
      "Return the final number representing all the flag switches we flipped.",
      "The final '}' ends the function."
    ],
    defaultArgs: [["-a", "-b"]],
  ...
  },
  {
    ...
    explanations: [
      "Declares the RpnCalc function. It's a special calculator where you put the numbers first!",
      "Creates a data 'stack' to store our numbers.",
      "Splits the input into tokens (words or numbers).",
      "Loops through each token one by one.",
      "Tries to turn the token into a number. If it works, add it to the stack.",
      "If it's an operator, check if we have at least 2 numbers ready in our stack.",
      "Grabs the top two numbers and clears them from the stack.",
      "Uses a 'switch' to add, subtract, or multiply the numbers and saves the result.",
      "End of our decisions and the loop.",
      "Displays the final answer stored in our stack.",
      "The final '}' ends the function."
    ],
    defaultArgs: ["3 4 + 2 *"],
  ...
  },
  {
    ...
    explanations: [
      "Declares the Grouping function. It sorts words into families based on their shape!",
      "Creates a 'groups' notebook to hold lists of words that match the same pattern.",
      "Splits the text into words and loops through them.",
      "Calculates a unique 'Pattern' key for the word (its secret shape code).",
      "Adds the word to the list in our notebook that matches its shape code.",
      "End of the processing loop.",
      "Displays the final notebook of all the word families we found.",
      "The final '}' ends the function."
    ],
